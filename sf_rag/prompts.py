...
PROMPT['eval_doc_answ3'] = '''#relevant\n Imre Schlosser, Ferenc Puskas, Mokhtar Dahari, Ali Daiei, who all hold the record for most international goals. \n Ferenc Puskas was the first footballer to score 50 or more international goals. \n Ali Daiei became the first player to score over 100 goals in international football.'''
